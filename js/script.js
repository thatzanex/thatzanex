...
// Datum Sortieren schließen

function closeSortierenDatum() {
    var sortOptions = document.getElementById("sortieren");
    sortOptions.style.display = "none";
}


function toggleSortierenDatumCheck() {
    // Überprüfen, ob das Popup sichtbar ist
    var isPopupVisible = document.querySelector('.popup-content').style.display === 'block';

    // Wenn das Popup nicht sichtbar ist, das Sortierdiv ausblenden
    if (!isPopupVisible) {
        closeSortierenDatum();
    }
}
